...
<DefinitionList>
  ...
  <dd>
  [Creative Commons](https://creativecommons.org/) is an organization which publishes a set of licenses (see below) for content that is not intended to be proprietary. They provide guidance for annotating your content so that it can be shared and reused with limitations of your choosing.
  </dd>
