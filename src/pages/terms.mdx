...
<Intro>
  Welcome to Pinecast. Before you use our service, you should understand these Terms of Use ("Terms") and our Privacy Policy. Anyone who uses Pinecast—to produce or consume content or for any other reason—agrees to these Terms.

  If you do not agree with any of the Terms presented here, you may not use Pinecast.
</Intro>
...
- Content intended to serve exclusively as advertisements or marketing material

### Reselling
You may not resell Pinecast's services without explicit authorization. Using Pinecast to host podcasts on behalf of others in exchange for compensation of any kind is considered reslling.

### Generated content
You may not use Pinecast to publish fully-generated content (e.g., content created using generative AI). The following restrictions apply:

- Content which was generated entirely through automated means (text-to-speech, LLM content generation) with little to no human interaction is strictly prohibited.
- Audio which is a text-to-speech reproduction of content availble online from a third-party source is strictly prohibited.
- Generated audio intended for advertising or other marketing purposes is not allowed.
- Reproducing the voice of a third party or altering their speech with the intention of deceiving listeners or causing confusion is prohibited.
...
By using Spotify for Creators, you agree to Spotify's terms of use. The text of this agreement is summarized below.
